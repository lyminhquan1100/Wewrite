...
import com.arcane.app.dto.ProductDTO;
import com.arcane.app.repository.ProductRepository;
import com.arcane.app.service.ProductService;
...
/**
 * REST controller for managing {@link com.arcane.app.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProductResource {
    ...
    public ProductResource(ProductRepository productRepository, ProductService productService, ModelMapper modelMapper) {
...
//    }
    @GetMapping("/products")
    public ResponseEntity<Page<ProductDTO>> getAllProduct(Pageable pageable, @RequestParam(required = false) String search) {
        Page<Product> entityPages = productService.getAllProducts(pageable, search);

        // convert entities --> dtos
        List<ProductDTO> dtos = modelMapper.map(
